<template>
  ...
  >
    ...
    >
      <p class="lowercase text-xl">info@armaprogen.com</p>
    ...
    >
      <div class="flex items-center">
        <NuxtLink
          class="w-[1.8rem] h-[1.8rem] flex justify-center items-center p-5 cursor-pointer mr-4 rounded-[50%] border border-black"
          rel="nofollow"
          target="_blank"
        ...
        <NuxtLink
          ...
          ><span class="transition icon icon-linkedin">
            ...
            >
              ...
              <g clip-path="url(#cp1)">
                <path class="a" d="m0.7 2.7h1.7v5.5h-1.7z" fill="#000" />
                <path
                  class="a"
