<template>
    ...
    <div class="container-middle">
      ...
      <div class="container-middle-center block-effect" style="--td: 1.2s">
        ...
        <p class="text block-reveal" style="--bc: #438cdd; --d: 1s">
          İşletmenizi <strong>Google ve sosyal medyada</strong> en kısa sürede
          en iyi noktada ulaştırmanız için 360 derece digital paket,<strong>
            Arma Digital'de</strong
          >
        </p>
      </div>
      <div class="container-middle-end">
        <div class="left">
          <h4 class="text">#360° DIGITAL YONETIM</h4>
        </div>
        <div class="center">
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown-item">
                    <NuxtLink class="dropdown-item-link"
                      >360° Digital Yonetim</NuxtLink
                    >
                  </li>
                  <li class="dropdown-item">
                    <NuxtLink class="dropdown-item-link"
                      >360° Seo Yonetimi</NuxtLink
                    >
                  </li>
                  <li class="dropdown-item">
                    <NuxtLink class="dropdown-item-link"
                      >360° Google Yonetimi</NuxtLink
                    >
                  </li>
                  <li class="dropdown-item">
                    <NuxtLink class="dropdown-item-link"
                      >360° Sosyal Medya Yonetimi</NuxtLink
                    >
                  </li>
                  <li class="dropdown-item">
                    <NuxtLink class="dropdown-item-link"
                      >360° Icerik Yonetimi</NuxtLink
                    >
                  </li>
                </ul>
              </li>
            ...
            <NuxtLink
              ...
              ><span class="transition icon icon-linkedin">
                ...
                >
                  ...
                  <g clip-path="url(#cp1)">
                    <path class="a" d="m0.7 2.7h1.7v5.5h-1.7z" fill="#fff" />
                    <path
                      class="a"
  ...
  <template>
    <main>
      <div class="grid grid-cols-13 grid-rows-1">
        <div
          class="col-span-1 col-start-1 col-end-2 grid grid-rows-7 max-h-[1080px] border border-r-slate-600"
        >
          <div
            class="row-span-1 row-start-1 row-end-2 col-span-1 border border-b-slate-600 w-full h-full"
          >
            <img
              src="@/assets/images/logo.svg"
              alt="arma-logo"
          ...
          <div
            class="row-span-3 row-start-2 row-end-5 border border-b-slate-600 w-full h-full"
          ></div>
          <div
            class="row-span-1 row-start-5 row-end-6 col-span-1 border border-b-slate-600 w-full h-full flex justify-center items-center"
          >
            <img alt="" class="invert" src="@/assets/images/icon-rocket.png" />
          </div>
          <div
            class="row-span-1 row-start-6 row-end-7 col-span-1 border border-b-slate-600 w-full h-full flex justify-center items-center"
          >
            <img alt="" class="invert" src="@/assets/images/icon-hearth.png" />
          </div>
          <div
            class="row-span-1 row-start-7 row-end-8 col-span-1 border border-b-slate-600 w-full h-full flex justify-center items-center"
          >
            <img
              alt=""
              class="invert"
        ...
        <div
          class="col-span-11 col-start-2 col-end-13 border border-b-slate-600"
        >
          <div class="flex row-start-1 row-end-2">
            <a href="">Ana sayfa</a>
            <a href="">Ana sayfa</a>
            <a href="">Ana sayfa</a>
          </div>
        ...
        <div
          class="col-span-1 col-start-13 col-end-14 grid grid-rows-7 max-h-[1080px] border border-l-slate-600"
        >
          <div
            class="row-span-1 row-start-1 row-end-2 col-span-1 border border-b-slate-600 w-full h-full"
          >
          ...
          <div
            class="row-span-4 row-start-2 row-end-6 border border-b-slate-600 w-full h-full"
          ></div>
          <div
            class="row-span-1 row-start-6 row-end-7 col-span-1 border border-b-slate-600 w-full h-full flex justify-center items-center"
          >
            <img
              alt=""
              class="invert aspect-square w-full h-full"
